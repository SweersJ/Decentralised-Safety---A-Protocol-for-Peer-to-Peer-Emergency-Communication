...
1. Unzip the latest folder in the `C:\Users\<user_name>\AppData\Roaming\npm\node_modules\@informalsystems\` if there isn't anything yet. Otherwise remove the current code and put the zip folder and extract it in that location.

## WSL

1. Unzip the latest folder in the `/mnt/c/Users/<user_name>/AppData/Roaming/npm/` if there isn't anything yet. Otherwise remove the current code and put the zip folder and extract it in that location.

## Linux

1.  Unzip the latest folder in the `/usr/local/lib/node_modules/@informalsystems/` if there isn't anything yet. Otherwise remove the current code and put the zip folder and extract it in that location.
